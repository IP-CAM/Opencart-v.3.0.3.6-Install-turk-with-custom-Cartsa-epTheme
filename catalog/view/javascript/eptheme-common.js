...
$(document).ready(function () {
  ...
  $('input[mockup-key="caseColor"]').click(function () {
    var mockupValue = $(this).attr("mockup-value");

    if (!mockupValue) return;

    $("#gallery_01 a")
      .filter(function (index, element) {
        return decodeURIComponent(element.href).includes(mockupValue);
      })
      .click();
  });
      ...
      success: function (json) {
        ...
        if (json.success) {
          $("#content")
            .parent()
            .before(
              '<div class="a-one"><div class="alert alert-success alert-dismissible alertsuc"><svg width="20px" height="20px"> <use xlink:href="#successi"></use> </svg> ' +
                json.success +
          ...
          setTimeout(function () {
            $("#cart > button").html(
              '<svg><use xlink:href="#hcart"></use></svg><span id="cart-total" class="hdis text-left">' +
                json["total"] +
                "</span>"
            );
          }, 100);
