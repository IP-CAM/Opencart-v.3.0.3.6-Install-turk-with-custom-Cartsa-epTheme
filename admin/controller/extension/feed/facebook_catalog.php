...
class ControllerExtensionFeedFacebookCatalog extends Controller {
    ...
    {
        $this->language->load('extension/feed/facebook_catalog');
        ...
        $availability = array(
            'in stock' => $this->language->get('text_in_stock'),
            'out of stock' => $this->language->get('text_out_of_stock'),
            'preorder' => $this->language->get('text_preorder'),
            'available for order' => $this->language->get('text_available_for_order'),
            'discontinued' => $this->language->get('text_discontinued'),
            'skip products' => $this->language->get('text_skip_products')
        );
        ...
        $data['sm_gtin_source'] = $this->model_extension_feed_google_merchant_center->createCheckboxSetting($prefix, 'gtin_source', array('ean' => 'EAN', 'upc' => 'UPC', 'jan' => 'JAN', 'isbn' => 'ISBN'), 'ean');
        ...
        $data['feed_url'] = $base_url.$http_sep.'index.php?route=extension/feed/facebook_catalog';
